USE germplasm_directory;

CREATE TABLE `germplasm` (
	`id` int NOT NULL AUTO_INCREMENT,
    `deletado` boolean DEFAULT FALSE,
    `nome` varchar(90) NOT NULL,
    `tipo_de_material_genetico` varchar(90) NOT NULL,
    `textura_do_grao` varchar(90) NOT NULL,
    `origem` varchar(90) NOT NULL,
    `transgenico` boolean DEFAULT FALSE,
    `eventos_transgenicos` varchar(90) NOT NULL,
    `local_na_camara_fria` varchar(90) NOT NULL,
    `data_de_entrada` DATETIME NOT NULL,
    `data_da_ultima_colheita` DATETIME NOT NULL,
    `colletotrichum_graminicola` INT DEFAULT NULL,
	`puccinia_sorghi` INT DEFAULT NULL,
	`exserohilum_turcicum` INT DEFAULT NULL,
	`phaeosphaeria_maydis` INT DEFAULT NULL,
	`puccinia_polysora` INT DEFAULT NULL,
	`physopella_zeae` INT DEFAULT NULL,
	`corn_stunt` INT DEFAULT NULL,
	`diplodia_maydis` INT DEFAULT NULL,
	`fusarium_moniliforme` INT DEFAULT NULL,
	`gibberella_zeae` INT DEFAULT NULL,
    `altura_de_planta` FLOAT DEFAULT NULL,
	`altura_de_espiga` FLOAT DEFAULT NULL,
	`diametro_da_espiga` FLOAT DEFAULT NULL,
	`numero_de_graos_por_fileira` FLOAT DEFAULT NULL,
	`numero_de_fileiras_de_graos_por_espiga` FLOAT DEFAULT NULL,
	`comprimento_de_espigas` FLOAT DEFAULT NULL,
	`rendimento_de_graos` FLOAT DEFAULT NULL,
	`capacidade_de_expansao` FLOAT DEFAULT NULL,
	`massa_de_cem_graos` FLOAT DEFAULT NULL,
	`numero_de_espigas` FLOAT DEFAULT NULL,
	`diametro_do_colmo` FLOAT DEFAULT NULL,
	`comprimento_de_grao` FLOAT DEFAULT NULL,
	`largura_de_grao` FLOAT DEFAULT NULL,
	`espessura_de_grao` FLOAT DEFAULT NULL,
	`espessura_do_pericarpo` FLOAT DEFAULT NULL,
	`difusividade_termica_do_pericarpo` FLOAT DEFAULT NULL,
	`teor_de_proteina` FLOAT DEFAULT NULL,
	`teor_de_oleo` FLOAT DEFAULT NULL,
	`amido_total` FLOAT DEFAULT NULL,
